...
message(STATUS "hmm_sim: 2 messages, 0 services")
...
add_custom_target(_hmm_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hmm_sim" "/home/sebastiano/hmm_workspace/src/hmm_sim/msg/classifier_output.msg" "std_msgs/MultiArrayDimension:std_msgs/MultiArrayLayout:std_msgs/Float32MultiArray"
)

get_filename_component(_filename "/home/sebastiano/hmm_workspace/src/hmm_sim/msg/traversability_output.msg" NAME_WE)
add_custom_target(_hmm_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hmm_sim" "/home/sebastiano/hmm_workspace/src/hmm_sim/msg/traversability_output.msg" "std_msgs/MultiArrayDimension:std_msgs/MultiArrayLayout:std_msgs/Float32MultiArray"
)
